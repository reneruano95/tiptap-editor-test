...
export const MenuList = React.forwardRef((props: MenuListProps, ref) => {
  ...
  return (
    <div
      ref={scrollContainer}
      className="text-black max-h-[min(80vh,24rem)] overflow-auto flex-wrap mb-8 p-2 bg-white rounded-lg dark:bg-black shadow-sm border border-neutral-200 dark:border-neutral-800"
    >
